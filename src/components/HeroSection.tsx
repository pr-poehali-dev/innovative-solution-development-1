          ...
          <div className="flex max-w-2xl flex-col gap-12">
            ...
            >
              <div className="relative h-48 w-48 overflow-hidden rounded-full border-4 border-white shadow-2xl md:h-64 md:w-64">
                <img
                  src="https://cdn.poehali.dev/projects/15a170ae-8ff1-4a9f-aa71-a8e7eb8c33ee/bucket/d196cd60-41b2-4fce-afc6-5a063d0b1016.jpeg"
                  alt="Житков Святослав Антонович"
                  className="h-full w-full object-cover"
                />
              </div>
            </div>
            ...
            >
              <div className="space-y-6">
                ...
                <p className="text-xl font-light text-white/80 md:text-2xl">
                  Физик-химик-ядерщик | Квантовый философ
                </p>
                <p className="text-base font-light leading-relaxed text-white/70 md:text-lg">
                  Физик-химик-ядерщик по будням и квантовый философ по выходным, 
                  спринтер на короткие дистанции и марафонец по жизни, уролог с тонкой 
                  душевной организацией и сексолог по зову сердца. Параллельно — 
                  астрофизик-любитель, биохакер-самоучка, инженер по настройке кармы, 
                  айтишник без компьютера, программист на бумаге и дебаггер чужих судеб.
                </p>
